...
var _ = Describe("Generator", func() {
	...
	Describe("GenerateGoMod", func() {
		It("should generate valid go.mod content", func() {
			...
			Expect(codeStr).To(ContainSubstring("module github.com/vi2play/vi2play/plugins/pdk/go"))
			// Ensure it's not the old host-specific path
			Expect(codeStr).NotTo(ContainSubstring("module github.com/vi2play/vi2play/plugins/pdk/go/host"))
	...
	Describe("GenerateClientGo", func() {
		...
		It("should generate valid Go code structure", func() {
			...
			Expect(codeStr).To(ContainSubstring("github.com/vi2play/vi2play/plugins/pdk/go/pdk"))
		})
