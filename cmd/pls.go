...
var (
	plsCmd = &cobra.Command{
		...
		Long:  "Export vi2play playlists to M3U files",
	...
	exportCommand = &cobra.Command{
		...
		Long:  "Export one or more vi2play playlists to M3U files",
		Run: func(cmd *cobra.Command, args []string) {
	...
	importCommand = &cobra.Command{
		...
		Long:  "Import one or more M3U files as vi2play playlists",
